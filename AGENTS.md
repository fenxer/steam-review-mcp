...
When a prompt explicitly mentions "spec mode", strictly follow the guidelines and requirements documented in `.context/spec/README.md`.
...
- **Spec Mode Guidelines**: `.context/spec/README.md` - Complete specification-driven development workflow
